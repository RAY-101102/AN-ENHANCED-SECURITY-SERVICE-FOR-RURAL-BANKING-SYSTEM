        ...
        <div class="container-fluid">
            <form id="account-form">
                ...
                <div class="form-group">
                    ...
                    <a href="/banking/client/transaction/Trans/transposition.php">Generate Cipher password</a>
					<input type="password" name="password" id="password" class="form-control" value="<?php echo isset($keyword)? $keyword: '' ?>" required autocomplete="off">
